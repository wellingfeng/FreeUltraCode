...
export const FREE_CHANNELS: FreeChannel[] = [
  ...
  },
  {
    ...
    fallbackModels: ['openai/gpt-5.2', 'openai/gpt-5-nano', 'openai/gpt-4.1', 'xai/grok-code-fast-1'],
  ...
  },
  {
    ...
    fallbackModels: ['gpt-5.4-codex', 'gpt-5.4', 'gpt-5-nano', 'gpt-5.1', 'gpt-4.1'],
    credentialUrl: 'https://platform.openai.com/api-keys',
    local: false,
    needsKey: true,
    note: 'Official OpenAI-compatible text endpoint. Use for GPT coding models when you want direct OpenAI API routing.',
  },
  {
  ...
  },
  {
    ...
    fallbackModels: ['kimi-k2.6', 'kimi-k2-thinking', 'kimi-k2-0905-preview', 'moonshot-v1-32k'],
  ...
  },
  {
    ...
    defaultModel: 'glm-5.1',
    fallbackModels: ['glm-5.1', 'glm-4.7', 'glm-4.6'],
