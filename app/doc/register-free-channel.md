...
打开底部 **Channel** 下拉列表，选择一个还带警告符号的免费渠道。截图里选择的是 **Free · OpenRouter**。
...
<p align="center">
  <img src="images/注册免费渠道/2-注册.png" alt="打开渠道注册网站" width="960">
</p>
...
如果想一次性检查所有渠道，点击左下角 **设置**，再进入 **渠道** -> **免费渠道**。这里会列出每个渠道的状态、API Key、默认模型和 **获取 Key** 入口。
