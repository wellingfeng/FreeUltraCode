...
UltraGameStudio एक Claude Code / Codex / Gemini जैसा agent लेकर उसे game development के लिए गहराई से customize करता है:
...
UltraGameStudio में 40+ game-development specialists built-in हैं, जिन्हें agent task के अनुसार अपने आप बुलाता है:
...
<p align="center">
  ...
  <img src="images/hero-free-channels.hi.png" alt="UltraGameStudio मुफ्त चैनल रूटिंग स्क्रीनशॉट" width="960">
</p>
...
### डायनेमिक वर्कफ़्लो (/studio)

जटिल बहु-चरणीय प्रोग्रामिंग कार्यों के लिए, `/studio <कार्य>` तुरंत एक विशेष एक्ज़ीक्यूशन हार्नेस उत्पन्न करता है और उसे तुरंत चलाता है। विज़ुअल कैनवास की आवश्यकता नहीं है।
...
- हर रन `.ugs-run/<run-id>/` के अंतर्गत पूरी तरह लॉग होता है जिसमें कार्य बही, घटनाएँ, निर्णय और अंतिम परिणाम शामिल हैं।
- डेस्कटॉप ऐप या CLI से चलाएँ: `ugs studio "<कार्य>" --json --interactive --cwd <workspace>`।
...
`/studio` के साथ, हार्नेस योजना चरणों में कई प्रदाताओं को स्वचालित रूप से जोड़ सकता है। सामान्य पैटर्न: DeepSeek कम लागत पर ड्राफ्ट तैयार करता है, CodeX अंतिम गुणवत्ता तक परिष्कृत करता है।
...
- **cc-switch संगतता**: UltraGameStudio `cc-switch` CLI कॉन्फ़िगरेशन पढ़ता है; Claude Code रूटिंग के लिए कॉन्फ़िगर किया गया कोई भी प्रदाता studio चरणों के लिए तुरंत उपलब्ध है।
...
ये सुविधाएँ `/studio` हार्नेस रन को तब भी लचीला बनाए रखती हैं जब व्यक्तिगत मुफ़्त प्रदाता धीमे, दर-सीमित, या अस्थायी रूप से अनुपलब्ध हों।
...
4. key को UltraGameStudio में paste करें और **Save and Use** पर click करें। save होने के बाद warning mark हट जाएगा।
...
4. desired asset describe करें। UltraGameStudio पहले programming model से prompt polish करवाता है, फिर configured provider को भेजता है।

<p align="center">
  <img src="images/生图/session-2026-06-07-2351.png" alt="Asset mode उसी UltraGameStudio session में सामग्री generate करता है" width="720">
</p>
